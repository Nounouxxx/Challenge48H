...
export default function Enigme1({ onBack }: EnigmeProps) {
  ...
  return (
    <div className="enigme-page">
      <h1>🔐 Énigme 1 — Le point de départ</h1>
      <p>
        Dans un graphe, Dijkstra commence depuis un nœud source et calcule la plus courte
        <em> ________</em> vers tous les autres sommets.
      </p>
      <p style={{ opacity: 0.5, fontSize: "0.85rem" }}>
        Indice : ce mot mesure l’écart entre deux points dans un graphe pondré.
      </p>
